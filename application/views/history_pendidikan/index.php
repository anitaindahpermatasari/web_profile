    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card" style="width:auto; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="card-body">

                        <div class="col-md-10 mt-3">
                            <div class="row mt-5">
                                <div class="col-5">
                                    <a href="<?= base_url('admin/create_history_pendidikan') ?>" class="btn btn-success">Tambah Data</a>
									<a href="<?= base_url('admin/print_history_pendidikan');?>" target="_blank" type="button" class="btn btn-info">Cetak Data</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/edit_history_pendidikan/' . $history_pendidikan['id_pendidikan']) ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= base_url('admin/hapus_history_pendidikan/' . $history_pendidikan['id_pendidikan']) ?>" class="btn btn-danger">Hapus</a>
                                            </td>  
                                        </tr>
                                    <?php
                                    }
