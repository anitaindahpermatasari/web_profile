        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card" style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
					<h1 align="center">	Tambah History Pendidikan</h1>
                        <form action="<?= base_url('admin/simpanhistory_pendidikan') ?>" method="POST">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
                      				<input type="text" name="jurusan" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Jurusan">
								</div>
                            </div>
							<div class="mb-3 row">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">	
                                	<input type="decimal" name="nilai_akhir" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Nilai Akhir">
								</div>
                            </div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Prestasi</label>
								<div class="col-sm-10">
                                	<input type="text" name="prestasi" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Prestasi">
								</div>
                            </div>
                            <div class="mb-3">
