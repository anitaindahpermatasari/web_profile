    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!DOCTYPE html>
                <html lang="en">
				<section class="resume-section" id="history_pendidikan">
						<div class="resume-section-content">
							<div class="card " style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                   			<div class="mt-3">
							<h1 align="center">History Pendidikan</h1>
							<table class="table table-hover mt-3 table-primary text-black">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($history_pendidikan_list as $list) {
                                    ?>
                                        <tr>
                                            <th><?= $list['id_pendidikan']; ?></th>
                                            <td><?= $list['id_user']; ?></td>
                                            <td><?= $list['jenjang']; ?></td>
