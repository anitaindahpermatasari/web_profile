        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card" style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
					<h1 align="center">	Edit Pengalaman</h1>
						<a class="btn btn btn-warning" href="<?= base_url('admin/pengalaman/') ?>">Kembali</a>
						<br><br>
                        <form action="<?= base_url('admin/editpengalaman') ?>" method="POST">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input type="text" name="id_user" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan ID User" value="<?= $pengalaman['id_user'] ?>">
								</div>
							</div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Nama Instansi</label>
								<div class="col-sm-10">
                                	<input type="text" name="nama_instansi" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Nama Instansi" value="<?= $pengalaman['nama_instansi'] ?>">
								</div>
                            </div>
                            <div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Jenis Instansi</label>
								<div class="col-sm-10">
									<select class="form-select" name= "jenis_instansi" aria-label="Default select example" value="<?= $pengalaman['jenis_instansi'] ?>">
							...
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Jabatan</label>
								<div class="col-sm-10">
                      				<input type="text" name="jabatan" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Jabatan" value="<?= $pengalaman['jabatan'] ?>">
								</div>
                            </div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Tahun</label>
								<div class="col-sm-10">	
                                	<input type="text" name="tahun" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Tahun Awal-Tahun Akhir Pendidikan" value="<?= $pengalaman['tahun'] ?>">
								</div>
                            </div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Tanggung Jawab</label>
								<div class="col-sm-10">
                                	<input type="text" name="tanggung_jawab" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Tanggung Jawab" value="<?= $pengalaman['tanggung_jawab'] ?>">
								</div>
                            </div>
							<div class="mb-3">
