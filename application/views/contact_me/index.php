                ...
                <div class="card" style="width: auto; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="card-body">
                        ...
                        <div class="col-md-10 mt-3">
                            <div class="row mt-5">
                                <div class="col-5">
                                    <a href="<?= base_url('admin/create_contact_me') ?>" class="btn btn-success">Tambah Data</a>
									<a href="<?= base_url('admin/print_contact_me');?>" target="_blank" type="button" class="btn btn-info">Cetak Data</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/edit_contact_me/' . $contact_me['id_contact']) ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= base_url('admin/hapus_contact_me/' . $contact_me['id_contact']) ?>" class="btn btn-danger">Hapus</a>
                                            </td>  
                                        </tr>
                                    <?php
                                    }
