        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card" style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
					<h1 align="center">	Tambah Contact Me</h1>
                        <form action="<?= base_url('contact_me/simpancontact_me') ?>" method="POST">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
                                	<input type="text" name="email" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Alamat Email">
								</div>
                            </div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Github</label>
								<div class="col-sm-10">
                                	<input type="text" name="github" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Link Akun Github">
								</div>
                            </div>
							<div class="mb-3 row">
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-10">	
                                	<input type="text" name="instagram" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Link Akun Instagram">
								</div>
                            </div>
							<div class="mb-3 row">
                                <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Youtube</label>
								<div class="col-sm-10">
                                	<input type="text" name="youtube" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Link Akun Youtube">
								</div>
                            </div>
                            <div class="mb-3">
